...
import com.fphoenixcorneae.util.toast.style.ToastAliPayStyle
import com.fphoenixcorneae.util.toast.style.ToastBlackStyle
import com.fphoenixcorneae.util.toast.style.ToastQQStyle
import com.fphoenixcorneae.util.toast.style.ToastWhiteStyle
...
object ToastUtil {
    ...
    fun show(id: Int) {
        ...
        try {
            // 如果这是一个资源 id
            show(
                sToast!!.view!!.context.resources.getText(id)
            )
