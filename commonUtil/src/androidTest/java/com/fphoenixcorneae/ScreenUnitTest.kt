...
class ScreenUnitTest {
    ...
    fun getScreenWidth() {
        ...
        println()
        val display = appContext.windowManager?.defaultDisplay
        val size = Point()
        display?.getSize(size)
        print("Display.getSize: ${size.x}")
        println()
        print("Display.getWidth: ${appContext.windowManager?.defaultDisplay?.width}")
        println()
    ...
    fun getScreenHeight() {
        ...
        println()
        print("Display.getHeight: ${appContext.windowManager?.defaultDisplay?.height}")
        println()
        val displayMetrics = DisplayMetrics()
        appContext.windowManager?.defaultDisplay?.getMetrics(displayMetrics)
    ...
    fun landscape_portrait() {
        ...
        println()
        print("isLandscape: ${appContext.resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE}")
        println()
        print("isPortrait: $isPortrait")
        println()
        print("isPortrait: ${appContext.resources.configuration.orientation == Configuration.ORIENTATION_PORTRAIT}")
        println()
        print("//==============================landscape_portrait=======================================//")
        println()
    }
